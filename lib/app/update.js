...
function update(y) {
    ...
    dGroup.transition()
        ...
        .delay(delay*0.7)
        .text("2016")
        .attr("transform", "translate(" + (outerRadius+30) + ","  + (outerRadius + 90) +")")
        .style("font-size", fs + "px");
    ...
    eText.enter()
        ...
        .text(function(d) { if(d.index!=20){return  (d.index+1)  + ". " + d.label; } })
        .on("mouseover", function (d) { node_onMouseOver_export(d); })
    ...
    iText.enter()
        ...
        .text(function(d) { if(d.index !=20){return  (d.index+1)  + ". " + d.label;}})
        .on("mouseover", function (d) { node_onMouseOver_import(d); })
        .on("mouseout", function (d) {node_onMouseOut(d); });
